...
@interface ALPrivacyPolicyViewController ()<UITextFieldDelegate,UIGestureRecognizerDelegate> {
...
@implementation ALPrivacyPolicyViewController
...
- (void)viewDidLoad
{
    ...
    [TableviewDetails setText:@"Privacy Policy"];
